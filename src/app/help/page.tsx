  ...
  payments: [
    {
      ...
      a: 'GadgetSwap uses a multi-layer protection system to keep your transactions safe:\n\n1. **24-Hour Escrow Window**: When you pay, funds are held securely by Stripe — not released to the seller immediately. After delivery is confirmed, you have **24 hours to inspect the device**. During this window, if you raise any concerns, GadgetSwap can directly review and facilitate a refund — no need to involve banks or file disputes.\n\n2. **Direct Resolution (First 24 Hours)**: If something is wrong with your order, contact us immediately. While funds are still in escrow, our team can quickly review photos/evidence and process refunds directly. This is the fastest path to resolution.\n\n3. **Stripe Dispute Protection (After 24 Hours)**: Once the 24-hour window closes, funds are released to the seller. If issues arise after this point, you\'ll need to file a dispute through Stripe or your bank (chargeback). Our system automatically pauses any pending seller payouts while disputes are reviewed.\n\n4. **Automatic Delivery Tracking**: We monitor carrier tracking (UPS, FedEx, USPS) automatically. Once delivery is confirmed, the 24-hour inspection window begins — no action needed from you.\n\n**Bottom line:** Inspect your device right away and report issues within 24 hours for the smoothest refund process. After 24 hours, Stripe\'s dispute system takes over.',
      id: 'buyer-protection',
    },
    {
    ...
    },
    {
      ...
      a: '**Within 24 hours of delivery:** If you have any concerns about your purchase, contact GadgetSwap directly. During this window, funds are still held in escrow and our team can quickly review and facilitate a full refund if the item doesn\'t match the description or there\'s an issue.\n\n**After 24 hours:** Once the 24-hour inspection window closes, funds are released to the seller. At this point, refunds require filing a dispute through Stripe or your bank (chargeback). Our system will automatically pause any pending payouts while the dispute is reviewed.\n\nWe strongly recommend inspecting your device immediately upon delivery and reporting any issues within the 24-hour window for the fastest resolution.',
      id: 'refunds',
    },
    {
