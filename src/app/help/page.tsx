  ...
  payments: [
    {
      ...
      a: '**IMPORTANT: You have 24 hours after delivery to inspect your device and report any issues directly to GadgetSwap for fast resolution.**\n\nGadgetSwap uses a multi-layer protection system to keep your transactions safe:\n\n1. **24-Hour Escrow Window**: When you pay, funds are held securely — not released to the seller immediately. After delivery is confirmed, you have **24 hours to inspect the device**. During this window, if you raise any concerns, GadgetSwap can directly review and facilitate a refund — no need to involve banks or file disputes.\n\n2. **Direct Resolution (First 24 Hours)**: If something is wrong with your order, contact us immediately. While funds are still in escrow, our team can quickly review photos/evidence and process refunds directly. This is the fastest and easiest path to resolution — typically resolved within days.\n\n3. **Bank Dispute Protection (After 24 Hours)**: Once the 24-hour window closes, funds are released to the seller. If issues arise after this point, you must file a chargeback dispute with your bank/card issuer. This process typically takes **2-3 months** for final resolution, and your bank makes the final decision — not GadgetSwap.\n\n4. **Automatic Delivery Tracking**: We monitor carrier tracking (UPS, FedEx, USPS) automatically. Once delivery is confirmed, the 24-hour inspection window begins — no action needed from you.\n\n**Bottom line:** Open and inspect your device immediately upon delivery. The 24-hour window is your best protection — after that, the process becomes significantly longer and more complicated.\n\nLearn more about the dispute process: https://support.stripe.com/topics/disputes',
      id: 'buyer-protection',
    },
    {
    ...
    },
    {
      ...
      a: 'When you buy, payment is held securely — not sent to the seller immediately. After delivery is confirmed (via carrier tracking or your manual confirmation), funds are held for an additional **24 hours** before being released to the seller.\n\n**This 24-hour window is crucial!** During this time, you can inspect the device and contact GadgetSwap if there are any issues. Our team can review and process refunds directly while funds are still in escrow.\n\nOnce the 24 hours pass, funds are released to the seller and refunds require a lengthy bank dispute process (2-3 months). Always inspect your device immediately upon delivery.',
      id: 'escrow',
    },
    {
      q: 'Can I get a refund?',
      a: '**CRITICAL: Inspect your device within 24 hours of delivery!**\n\n**Within 24 hours of delivery:**\nContact GadgetSwap directly — this is by far the fastest and easiest path to resolution. During this window, funds are still held in escrow and our team can review your case and facilitate a full refund if the item doesn\'t match the description. Resolution typically takes just a few days.\n\n**What to check when your device arrives:**\n• **Physical condition** — Does it match the listed condition (Mint, Excellent, Good, Fair)? Check for scratches, dents, or damage not shown in photos\n• **iOS/Software version** — Go to Settings > General > About and verify it matches the listing\n• **Storage capacity** — Confirm GB matches what was advertised\n• **Carrier compatibility** — Verify the IMEI directly with your carrier, try eSIM transfer, or insert a physical SIM if applicable\n• **Battery health** — Check Settings > Battery > Battery Health for maximum capacity percentage\n• **All functions work** — Test cameras, speakers, microphone, Face ID/Touch ID, buttons, charging port\n• **Genuine parts** — Check Settings > General > About for any "Unknown Part" warnings indicating 3rd-party repairs\n• **iCloud status** — Ensure the device is signed out of the previous owner\'s iCloud account\n• **IMEI check** — Verify the IMEI isn\'t blacklisted by checking with your carrier\n\n**After 24 hours (Not Recommended):**\nOnce the inspection window closes, funds are released to the seller and GadgetSwap can no longer directly process refunds. At this point, your only option is to file a chargeback dispute with your bank or card issuer. Here\'s what that involves:\n\n• You must contact your bank and file a formal dispute\n• Your bank will investigate and may request evidence from you\n• The process typically takes **2-3 months** for final resolution\n• Your bank makes the final decision — not GadgetSwap\n• There is no guarantee of success\n\n**Don\'t wait!** Open your package and test your device as soon as it arrives. The 24-hour window exists to protect you — use it.\n\nLearn more about disputes: https://support.stripe.com/topics/disputes',
      id: 'refunds',
    },
    {
